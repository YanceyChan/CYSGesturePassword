...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIView * view = [[UIView alloc]initWithFrame:CGRectMake(frame.size.width/2-160, frame.size.height/2-160, 320, 320)];
        for (int i=0; i<9; i++) {
            NSInteger row = i/3;
            NSInteger col = i%3;
            // Button Frame
        ...
        state = [[UILabel alloc]initWithFrame:CGRectMake(frame.size.width/2-140, 60, 280, 30)];
