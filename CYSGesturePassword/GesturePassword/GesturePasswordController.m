...
- (void)reset{
    gesturePasswordView = [[GesturePasswordView alloc]initWithFrame:[UIScreen mainScreen].bounds];
    [gesturePasswordView.state setText:@"请设置密码"];
    [gesturePasswordView.state setTextColor:[UIColor colorWithRed:0.0 green:0.9127 blue:1.0 alpha:1.0]];
...
- (void)change{
    gesturePasswordView = [[GesturePasswordView alloc]initWithFrame:[UIScreen mainScreen].bounds];
    [gesturePasswordView.tentacleView setChangeDelegate:self];
    [gesturePasswordView.tentacleView setStyle:3];
    [gesturePasswordView setGesturePasswordDelegate:self];
    
    [gesturePasswordView.state setTextColor:[UIColor colorWithRed:0.6623 green:1.0 blue:0.0466 alpha:1.0]];
